...
activities = {
    ...
    "Basketball Team": {
        "description": "Train and compete in basketball games against other schools",
    ...
    "Drama Club": {
        "description": "Practice acting, stage production, and theater workshops",
    ...
    "Science Olympiad": {
        "description": "Work on science experiments and academic competition events",
